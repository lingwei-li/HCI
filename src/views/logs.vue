<template>
  <z-view style="border-width: 12px" label="Console">
    <ul>
    ...
    <div slot="extension">
      ...
      <z-dialog v-if="openDialog" self-close v-on:done="openDialog = false">
        ...
        <div slot=extension>
          ...
          <z-spot class="danger" button :angle="135" size="s" :distance="120" @click.native="openDialog = false">
  ...
  data () {
    return {
      ...
      console: [
        ...
        '5:20pm - The washing machine completes the laundry task',
        '5:30pm - The food in refrigerator is thawed and you can start cooking',
        ...
        '7:30pm - The bath is drained, you can go to the bath',
