<template>
  <z-view>
    ...
    <section slot="extension">
      ...
      <z-spot button :angle="45" size="s" :distance="120" label="Add" @click.native="openDialog = true">
        <i class="fas fa-plus"></i>
      </z-spot>
      <z-dialog v-if="openDialog" self-close v-on:done="openDialog = false">
        Add a new room?
        <div slot=extension>
          <z-spot class="success" button :angle="45" size="s" :distance="120" @click.native="openDialog = false">
